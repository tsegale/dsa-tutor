...
const COMPLEXITY: Record<string, ComplexityRow> = {
  ...
  dfs: {
    ...
    average: 'O(V + E)', averageNote: 'V nodes, E edges',
    worst: 'O(V + E)', worstNote: 'full traversal',
    space: 'O(V)', spaceNote: 'stack + visited',
    stable: false,
  },
  dijkstra: {
    best: 'O(E)', bestNote: 'target finalised almost immediately',
    average: 'O(V² + E)', averageNote: 'linear-scan priority queue',
    worst: 'O(V² + E)', worstNote: 'every node finalised',
    space: 'O(V)', spaceNote: 'distances + parents',
    stable: false,
  },
  'bellman-ford': {
    best: 'O(E)', bestNote: 'converges after one pass',
    average: 'O(V × E)', averageNote: '',
    worst: 'O(V × E)', worstNote: 'all V-1 passes needed',
    space: 'O(V)', spaceNote: 'distances + parents',
    stable: false,
  },
  'floyd-warshall': {
    best: 'O(V³)', bestNote: 'always - no early exit',
    average: 'O(V³)', averageNote: '',
    worst: 'O(V³)', worstNote: 'always',
    space: 'O(V²)', spaceNote: 'the distance matrix',
    stable: false,
  },
  kruskal: {
    best: 'O(E log E)', bestNote: 'dominated by the sort',
    average: 'O(E log E)', averageNote: '',
    worst: 'O(E log E)', worstNote: 'dominated by the sort',
    space: 'O(V)', spaceNote: 'union-find structure',
    stable: false,
  },
  prim: {
    best: 'O(V²)', bestNote: 'linear-scan candidate search',
    average: 'O(V²)', averageNote: '',
    worst: 'O(V²)', worstNote: 'linear-scan candidate search',
    space: 'O(V)', spaceNote: 'MST membership + candidate edges',
    stable: false,
  },
  'cycle-detection': {
    best: 'O(V + E)', bestNote: 'cycle found early',
    average: 'O(V + E)', averageNote: '',
    worst: 'O(V + E)', worstNote: 'no cycle - full traversal',
    space: 'O(V)', spaceNote: 'colours + call stack',
    stable: false,
  },
  'connected-components': {
    best: 'O(V + E)', bestNote: 'always - every node/edge visited once',
    average: 'O(V + E)', averageNote: '',
    worst: 'O(V + E)', worstNote: 'always',
    space: 'O(V)', spaceNote: 'component labels + queue',
    stable: false,
  },
  'topological-sort': {
    best: 'O(V + E)', bestNote: 'always - every node/edge visited once',
  ...
  'grid-bfs': {
    best: 'O(1)', bestNote: 'start adjacent to end',
    average: 'O(rows × cols)', averageNote: '',
    worst: 'O(rows × cols)', worstNote: 'no path exists - full grid explored',
    space: 'O(rows × cols)', spaceNote: 'visited + frontier',
    stable: false,
  },
  'grid-dfs': {
    best: 'O(1)', bestNote: 'start adjacent to end',
    average: 'O(rows × cols)', averageNote: '',
    worst: 'O(rows × cols)', worstNote: 'no path exists - full grid explored',
    space: 'O(rows × cols)', spaceNote: 'visited + stack',
    stable: false,
  },
  'grid-dijkstra': {
    best: 'O(1)', bestNote: 'start adjacent to end',
    average: 'O((rows × cols)²)', averageNote: 'linear-scan priority queue',
    worst: 'O((rows × cols)²)', worstNote: 'no path exists',
    space: 'O(rows × cols)', spaceNote: 'visited + frontier',
    stable: false,
  },
  'grid-astar': {
    best: 'O(1)', bestNote: 'start adjacent to end',
    average: 'O(rows × cols)', averageNote: 'far fewer cells than Dijkstra, heuristic-guided',
    worst: 'O((rows × cols)²)', worstNote: 'no path exists - degrades toward Dijkstra',
    space: 'O(rows × cols)', spaceNote: 'visited + frontier',
    stable: false,
  },
  'maze-generation': {
    best: 'O(rows × cols)', bestNote: 'always - every cell carved once',
    average: 'O(rows × cols)', averageNote: '',
    worst: 'O(rows × cols)', worstNote: 'always',
    space: 'O(rows × cols)', spaceNote: 'visited set + backtracking stack',
    stable: false,
  },
  'maze-prim': {
    best: 'O(rows × cols)', bestNote: 'always - every cell carved once',
    average: 'O(rows × cols)', averageNote: '',
    worst: 'O(rows × cols)', worstNote: 'always',
    space: 'O(rows × cols)', spaceNote: 'frontier wall list',
    stable: false,
  },
  'maze-kruskal': {
    best: 'O(rows × cols × α(n))', bestNote: 'always - α is the near-constant inverse Ackermann function',
    average: 'O(rows × cols × α(n))', averageNote: '',
    worst: 'O(rows × cols × α(n))', worstNote: 'always',
    space: 'O(rows × cols)', spaceNote: 'union-find structure + shuffled wall list',
    stable: false,
  },
  stack: {
