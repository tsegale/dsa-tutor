...
export default function OpenMisconceptionIndicator({ category }: OpenMisconceptionIndicatorProps) {
  return (
    <div className="absolute top-4 left-4 z-10 flex items-center gap-1.5 rounded-full border border-secondary/40 bg-white px-3 py-1.5 text-xs font-medium text-text-secondary shadow-sm">
