...
const TOPICS = [
  ...
  { name: 'shell-sort', displayName: 'Shell Sort', track: 'SORTING', difficulty: 'INTERMEDIATE', description: 'Sort by comparing elements at a shrinking gap distance, generalising Insertion Sort.', estimatedMinutes: 12, isLocked: false, order: 999 },
  { name: 'heap-sort', displayName: 'Heap Sort', track: 'SORTING', difficulty: 'INTERMEDIATE', description: 'Build a max-heap then repeatedly extract the maximum element.', estimatedMinutes: 14, isLocked: false, order: 999 },
  { name: 'counting-sort', displayName: 'Counting Sort', track: 'SORTING', difficulty: 'INTERMEDIATE', description: 'Count element frequencies then reconstruct the sorted array in linear time.', estimatedMinutes: 12, isLocked: false, order: 999 },
  { name: 'radix-sort', displayName: 'Radix Sort (LSD)', track: 'SORTING', difficulty: 'ADVANCED', description: 'Sort digit by digit from least to most significant using stable bucket passes.', estimatedMinutes: 14, isLocked: false, order: 999 },
